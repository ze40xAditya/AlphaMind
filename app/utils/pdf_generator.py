...
def generate_invoice_pdf(
    ...
    elements.append(Paragraph("Email: billing@alphamind.com | Web: www.alphamind.com", subtitle_style))
    ...
    meta_data = [
        ...
        [
            Paragraph("<b>Payment Status:</b> Pending", cell_style),
            Paragraph("<b>Currency:</b> INR (₹)", cell_style)
        ]
    ]
